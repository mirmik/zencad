...
def topology_contract(
    ...
    assert_type(runtime.export_stl(shape, "shape.stl"), None)
    assert_type(runtime.export_step(shape, "shape.step"), None)
    assert_type(runtime.export_3mf(shape, "shape.3mf"), None)
