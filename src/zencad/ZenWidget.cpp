...
ZenWidget::ZenWidget(QWidget* parent) : QMainWindow(parent) {
...
void ZenWidget::createToolbars() {

}

void ZenWidget::about() {
    QMessageBox::about(this, tr("About ZenWidget"),
        tr("<h2>ZenWidget</h2>"
