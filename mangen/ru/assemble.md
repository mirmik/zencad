...
Юнит содержит два объекта координатного преобразования - location и global_location.
...
Обе детали находятся в системе координат `base`. Перемещение родителя переносит их вместе, сохраняя взаимное положение:
