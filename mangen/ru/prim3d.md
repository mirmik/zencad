...
---
## Параллелепипед
Объёмное тело - параллелипипед. Задаётся с указанием трёх размеров _x_, _y_, _z_. При указании одного размера _a_ генерируется куб _(a,a,a)_. `center=True` совмещает центр параллелепипеда с началом координат. Строка выбирает оси центрирования: `box(10, 20, 30, center="xy")` занимает X от −5 до 5, Y от −10 до 10, Z от 0 до 30.
...
---
## Цилиндр
Объёмное тело - цилиндр. Задаётся с указанием радиуса и высоты. Возможно построение сектора цилиндра с использованием необязательного параметра _yaw_. При `center=True` середина высоты располагается на Z=0.
...
---
## Конус
Объёмное тело - конус. Задаётся с указанием нижнего радиуса _r1_, верхнего радиуса _r2_ и высоты. Возможно построение сектора конуса с использованием необязательного параметра _yaw_. При `center=True` середина высоты располагается на Z=0. Радиусы _r1_ и _r2_ могут равняться нулю, что соответствует остроконечному конусу.
