...
from zencad._native.validation import ValidationReport
from zencad._native.trans import move
...
def widewire(
    ...
    from zencad._native.face import _circle, _wideedge
...
def helix(
    ...
    from zencad._native.wire import _helix
...
def fill_shape(shape: ResolvedShape) -> ResolvedShape:
    from zencad._native.face import _fill
...
def revolve_shape(
    ...
    from zencad._native.sweep import _revol
...
def loft_shapes(
    ...
    from zencad._native.sweep import _loft
...
def pipe_shape(
    ...
    from zencad._native.sweep import _pipe
...
def pipe_shell_shapes(
    ...
    resolved_parallel = (
        None if parallel is None else vector3(parallel.x, parallel.y, parallel.z)
    )
    return _pipe_shell(
        profiles,
        spine,
...
def revolve_sections_shape(
    ...
    from zencad._native.sweep import _revol2
...
def chamfer2d_shape(
    ...
    from zencad._native.near import _near_vertex
...
def draft_shape(
    ...
    from zencad._native.operations import _draft
...
def validate_shape(
    ...
    from zencad._native.validation import _validate
...
def sew_wire(
    ...
    from zencad._native.sew import _sew_wire
