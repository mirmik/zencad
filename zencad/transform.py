...
class LazyObjectTransformGeneratorCached(evalcache.LazyObject):
	...
	def __call__(self, *args, **kwargs): return evalcache.lazy.lazyinvoke(self, self, args, kwargs, encache=False, decache=False, cls=LazyObjectTransformCached)

class LazyObjectTransformGeneratorNoCached(evalcache.LazyObject):
	def __init__(self, *args, **kwargs): evalcache.LazyObject.__init__(self, *args, **kwargs)
	def __call__(self, *args, **kwargs): return evalcache.lazy.lazyinvoke(self, self, args, kwargs, encache=False, decache=False, cls=LazyObjectTransformNoCached)

class LazyObjectTransformCached(evalcache.LazyObject):
	def __init__(self, *args, **kwargs): evalcache.LazyObject.__init__(self, *args, **kwargs)
	def __mul__(self, oth): return evalcache.lazy.lazyinvoke(self, operator.__mul__, (self, oth), encache=False, decache=False, cls=LazyObjectTransformCached)
...
evalcache.lazy.hashfuncs[LazyObjectTransformNoCached] = evalcache.lazy.updatehash_LazyObject
evalcache.lazy.hashfuncs[LazyObjectTransformCached] = evalcache.lazy.updatehash_LazyObject
evalcache.lazy.hashfuncs[LazyObjectTransformGeneratorCached] = evalcache.lazy.updatehash_LazyObject
evalcache.lazy.hashfuncs[LazyObjectTransformGeneratorNoCached] = evalcache.lazy.updatehash_LazyObject
