...
from zencad._native.shape import shape_generator, Shape
from zencad._eager import eager
from zencad._native.boolops_base import occ_pair_union, occ_pair_difference, occ_pair_intersect
...
def section(a, b=0):
    ...
    """
    import zencad.util
    from zencad._native.solid import _halfspace
