...
from zencad._native.trans import translate
import zencad._native.exttrans
...
def _revol2(profile, r, n=30, yaw=(0, deg(360)), roll=(0, 0), sects=False, nparts=None):
    ...
    for ipart in range(nparts):
        ...
        for w in profile.wires():
            m = zencad._native.exttrans.rotate_array2(
                r=r,
                n=part_n,
                yaw=part_yaw,
                roll=part_roll,
    ...
    return zencad._native.boolops._union(rets)
